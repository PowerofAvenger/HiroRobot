...
import HiroRobot.modules.sql.global_bans_sql as gban_sql
import HiroRobot.modules.sql.users_sql as user_sql
from HiroRobot import DEV_USERS, OWNER_ID, dispatcher
